...
export default function CyberPump() {
  return (
    <div className="BentoBox   grid gap-2 lg:grid-cols-8">
      ...
      <div className="col-span-5 lg:col-span-3 lg:row-span-2">
        <img
          src="cyberpump2.png"
      ...
      <div className="hidden lg:block lg:col-start-5 row-start-3">
        <img
          src="cyberpump6.png"
      ...
      <div className="hidden lg:block lg:col-start-4 row-start-3">
        <img
          src="cyberpump3.png"
          className="h-full rounded-xl hover:scale-[200%]  border-[1px] border-white hover:border-deep-orange-700 transition-all duration-300"
        />
      </div>
      <div className="hidden lg:flex lg:border-4 border-white hover:border-deep-orange-700 rounded-xl  items-center lg:bg-black transition-all duration-300">
        <img
          src="react-2.svg"
          className="hover:scale-125 transition-all duration-300"
        />
      </div>
      <div className="hidden lg:flex lg:border-4 border-white hover:border-deep-orange-700 rounded-xl  items-center lg:bg-teal-500 transition-all duration-300 ">
        <img
          src="vitejs.svg"
          className="hover:scale-125 transition-all duration-300"
        />
      </div>
      <div className="hidden lg:flex lg:border-4 border-white hover:border-deep-orange-700 rounded-xl  items-center lg:bg-gray-800 transition-all duration-300">
        <img
